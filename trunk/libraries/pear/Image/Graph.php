 ...
 * @version    CVS: $Id:Graph.php 255 2007-04-11 03:19:14Z sam.moffatt@toowoombarc.qld.gov.au $
...
class Image_Graph extends Image_Graph_Element
{
    ...
    function &Image_Graph($params, $height = false, $createTransparent = false)
    {
        ...
        if ($this->_driver == null) {
            jimport('pear.Image.Graph.Driver');
            $this->_driver =&
    ...
    function &factory($class, $params = null)
    {
        ...
        jimport('pear.'. str_replace('_', '.', $class));
    ...
    {
        jimport('pear.Image.Graph.Layout.'.$layout);
...
//*/ // Generic Lockout For commenting  
?>