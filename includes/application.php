<?php
/**
 * myGovernance Application
 * 
 * myGovernance Core Application 
 * 
 * PHP4/5
 *  
...
/**
 * myGovernance Class
 * Work horse of entire system
 */
class JmyGovernance extends JApplication {

	var $_name = 'myGovernance';
	...
	*/
	...
	{
		$options = array();
		$menu =& parent::getMenu('mygovernance', $options);
		return $menu;
	}
	...
	{
		$options = array();
		$pathway =& parent::getPathway('mygovernance', $options);
		return $pathway;
	}
	...
	function &getRouter()
	{
		...
		$router =& parent::getRouter('mygovernance', $options);
		return $router;
	}
}